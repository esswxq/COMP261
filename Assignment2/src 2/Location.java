...
public class Location {
	...
	/**
	 * Makes a new Point object from this Location object and returns it. To create
	 * this Point, an origin location and the scale of the window are required. Note
	 * the vertical direction is inverted
	 */
	...
	/**
	 * Create a new Location object from a given Point object, as well as the origin
	 * and scale. This is effectively the opposite of the asPoint method.
	 */
	...
	/**
	 * Create a new Location object from the given latitude and longitude, which is
	 * the format used in the data files.
	 */
	...
	/**
	 * Returns a new Location object that is this Location object moved by the given
	 * dx and dy, ie. this returns a Location representing (x + dx, y + dy).
	 */
	...
	/**
	 * Return true if this location is within dist of other Uses manhattan distance
	 * for greater speed. Equivalent to whether other is within a diamond shape
